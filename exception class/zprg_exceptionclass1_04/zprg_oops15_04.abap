...
DATA: lo_exception TYPE REF TO zcx_exceptionclass1_04. "object of exception class
...
AT SELECTION-SCREEN.
  TRY. " in case of wrong order number
      SELECT SINGLE odate pm ta curr
        ...
        WHERE ono = p_ono.
      IF sy-subrc <> 0.
       RAISE EXCEPTION TYPE zcx_exceptionclass1_04
         EXPORTING
           textid = zcx_exceptionclass1_04=>zcx_exceptionclass1_04
*           previous =
           lv_order = p_ono
           .
    ...
    CATCH zcx_exceptionclass1_04 INTO lo_exception.
  ...
  TRY.
      IF p_ono IS INITIAL. " in case of no order number
        RAISE EXCEPTION TYPE zcx_exceptionclass1_04
          EXPORTING
            textid = zcx_exceptionclass1_04=>order_mandt
*           previous =
          .
