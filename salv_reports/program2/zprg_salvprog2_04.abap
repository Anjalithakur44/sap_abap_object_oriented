...
DATA: lo_salv TYPE REF TO cl_salv_table. "object for creating alv report

DATA: lo_cont TYPE REF TO cl_gui_custom_container. "object for creating container
...
INCLUDE zprg_salvprog2_04_user_commi01.